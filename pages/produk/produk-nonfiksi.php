...
<body>
  ...
  <h2>Produk Buku Non Fiksi</h2>

  <?php
  require_once(__DIR__ . '/../../model/Product.php'); // perhatikan slash sebelum ../
  $produk = new Product();

  // Ambil data produk dengan kategori 'Fiksi'
  $dataFiksi = $produk->getByCategory('Non Fiksi');
  ?>
